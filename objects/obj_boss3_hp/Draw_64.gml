...
var hpRatio = obj_boss3.boss3_hp / obj_boss3.boss3_hp_max ;  // Calculate the HP ratio (between 0 and 1)
...
draw_rectangle(100, 65, 100 + obj_boss3.boss3_hp*1.72  , 85, false);
#endregion
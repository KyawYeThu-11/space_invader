...
//	instance_destroy()
//}
if ((pulling) &&(obj_boss3_leg_left_moving_forward == true))
{
...
//creating asteroid
//if (obj_boss3_leg_left.x == obj_boss3_vul_area.astroid_pull_x) 
//{
if(obj_boss3_leg_left.y > 1080){
	obj_boss3_leg_left_moving_forward = false
	obj_boss3_leg_left.y -= 5
...
//}
//moving back
if ((pulling)&&(obj_boss3_leg_left_moving_forward == false)){
	move_towards_point(10, -100, 5)
	image_angle = point_direction(x, y, 10, -100) -90
}
//destroying
if (obj_boss3_leg_left.y < -90)
{
	instance_destroy()
}